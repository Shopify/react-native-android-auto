# React Native Android Auto: a contributor's guide
...
Shopify has adopted a Code of Conduct that we expect React Native Android Auto contributors to adhere to. Please read the [full text](./CODE_OF_CONDUCT.md) so that you can understand what actions will and will not be tolerated.

## Ways to contribute

There are many ways to contribute to React Native Android Auto, some of which are:

- Filing [bug reports](https://github.com/Shopify/react-native-android-auto/issues/new?template=BUG_REPORT.md)
- Requesting new features or packages via [an issue](https://github.com/Shopify/react-native-android-auto/issues/new/choose)
  - Bringing up areas for enhancement
- Hacking away on an issue from our [backlog](https://github.com/Shopify/react-native-android-auto/issues)
...
```bash
dev clone react-native-android-auto
dev up
```
...
- [Guides](../documentation/guides): a set of guides to help you get started developing with `react-native-android-auto`. Of particular note for developers just starting on the project is our guide to [creating a new package](../documentation/guides/creating-a-new-package.md).
...
If your change affects the public API of any packages within React Native Android Auto (i.e. adding or
...
The packages in React Native Android Auto are used in mission-critical production scenarios. As such, we try not to merge any untested code. The coverage doesn't strictly need to be 100% across the board, but testing should remain a primary concern.
...
```
git clone git@github.com:your-username/react-native-android-auto.git
```
